            ...
            for idx, frame in enumerate(bdddata['frame_list']):
                ...
                for label in frame['labels']:
                    ...
                    if label['category'] in interested_classes:
                        ...
                        # combine label as MZ ask
                        if label['category'] in ['UNCLEAR_LANE_MARKING', 'UNCLEAR_STOP_LINE', 'UNCLEAR_ROAD_MARKING']:
                            label['category'] = 'UNCLEAR_ROAD_MARKING'
                        elif label['category'] in ['CLEAN_STOP_SIGN', 'CLEAN_TRAFFIC_SIGN']:
                            label['category'] = 'CLEAN_TRAFFIC_SIGN'
                        elif label['category'] in ['DIRTY_STOP_SIGN', 'DIRTY_TRAFFIC_SIGN']:
                            label['category'] = 'DIRTY_TRAFFIC_SIGN'
